...
const NotificationSystem: React.FC<NotificationSystemProps> = ({ notifications, onDismiss, onNotificationClick }) => {
  return (
              ...
              <div className="relative z-10 p-5 flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                   <div className="flex justify-between items-start mb-1">
                      <h4 className={`font-serif font-bold text-sm tracking-wide ${textClass}`}>
                         {note.title}
                      </h4>
                      <button 
                        onClick={(e) => {
                   ...
                   <div className="mt-3 flex items-center justify-between border-t border-cp-border/30 pt-2">
                        ...
                        <div className="flex items-center gap-1.5 opacity-40 group-hover:opacity-100 transition-opacity">
                            <div className={`w-1.5 h-1.5 rounded-full ${accentClass} animate-pulse`}></div>
