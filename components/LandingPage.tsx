      ...
      <section className='relative z-10 py-24 px-6 overflow-hidden'>
        <div className='max-w-5xl mx-auto'>
          <div className='flex justify-between items-end mb-10'>
            ...
            <button className='text-cp-yellow text-[11px] font-semibold uppercase tracking-[0.45em] flex items-center gap-2 hover:text-white transition-colors'>
                ...
                <div className='flex-1'>
                  <div className='flex items-center gap-3'>
                    ...
                    <span className='px-2 py-0.5 text-[11px] font-semibold border border-cp-border text-cp-text-muted uppercase rounded-full tracking-[0.35em]'>
                      {t(`landing.badge.${item.badge.toLowerCase()}` as const)}
                    </span>
                  </div>
                </div>
